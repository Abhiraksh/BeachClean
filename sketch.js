...
function draw() {
  ...
  if(frameCount%300 === 0){
	...
	g1 = createSprite(random(0,1200),200,40,10);
	g1.addImage(g1i);
	g1.velocityY = 10
	g1.lifetime = 100;
	g1.scale = 0.2;
   ...
   if(frameCount%400===0){
	   g2 = createSprite(random(0,1200),200,40,10);
       g2.addImage(g2i);
	   g2.velocityY = 5
	   g2.lifetime = 100;
	   g2.scale = 0.3;
...
if(frameCount%400===0){
	g3 = createSprite(random(0,1200),200,40,10);
	g3.addImage(g3i);
	g3.velocityY = 12;
	g3.lifetime = 100;
	g3.scale = 0.3;
...
if(frameCount%50===0){
	g4 = createSprite(random(0,1200),200,40,10);
	g4.addImage(g4i);
	g4.velocityY = 5;
	g4.lifetime = 100;
	g4.scale = 0.3;
